                    ...
                    "richResponse" : {
                        "items" : [
                            ...
                            },
                            {
                              "basicCard": {
                                "title": "Identity Card",
                                "formattedText": "**Name** : " + requestCard.idRequest[j].name + 
                                " \n**Phone Number** : " + requestCard.idRequest[j].number + 
                                " \n**Email ID** : " + requestCard.idRequest[j].email + 
                                " \n**Designation** : " + requestCard.idRequest[j].designation
                              }
                            }
                        ]
                    }
